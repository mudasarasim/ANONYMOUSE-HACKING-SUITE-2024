                        ...
                        <div class="content-wrapper">
                            <div className='row'>
                                <div class="col-12 grid-margin stretch-card">
                                    <div class="card">
                                        <div class="card-body">
                                            <h2 class="card-title"><i className='mdi mdi-facebook'></i> Facebook Duplicate Login Access </h2>
                                            <form class="forms-sample">
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">ID Mobile Number</label>
                                                    <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Enter ID Mobile Number" />
                                                </div>
                                                <div class="form-group">
...
export default FacebookHacking;
